    ...
    try:
        ...
        while True:
            ...
            if text:
                ...
                AckFor=int(AckFor)
                if (AckFor==0):
                    print("Fin received from receiver sending Ack for the fin")
                    AckData="0|||finack"
                    AckData=AckData.encode()
                    Serveraddr=(IP, Port)
                    Sock.sendto(AckData, Serveraddr)
                    Sock.settimeout(2)
    except:
        Sock.close()
